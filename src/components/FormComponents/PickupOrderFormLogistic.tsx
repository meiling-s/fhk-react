import {
            ...
            >
              ...
              >
                    ...
                    <Grid item>
                      ...
                      {picoRefId !== '' ? (
                        ...
                        <div>
                          ...
                          >
                            <AddCircleIcon
                              sx={{ ...localstyles.endAdornmentIcon, pr: 1 }}
                            />
                ...
                <Grid item>
                  <Button
                    type="submit"
                    sx={[localstyles.buttonFilledGreen, localstyles.localButton]}
                  >
                    {t('pick_up_order.finish')}
                  </Button>
                  <Button
                    sx={[
                      localstyles.buttonOutlinedGreen,
  ...
  export default PickupOrderFormLogistic
