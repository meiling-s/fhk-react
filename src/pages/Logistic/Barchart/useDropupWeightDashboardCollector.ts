...
import { getDriverDropoffWeight } from "../../../APICalls/Logistic/dashboard";
...
const useDropupWeightDashboardWithIdRecycable = () => {
...
export default useDropupWeightDashboardWithIdRecycable;
