...
const DownloadArea = () => {
  ...
  const astdRows: reportItem[] = [
    ...
    {
      id: 2,
      report_name: t("generate_report.report_of_user_management_list"),
      typeFile: "XLS",
    ...
    {
      id: 3,
      report_name: t("generate_report.report_of_audit_trail"),
      typeFile: "XLS",
    ...
    {
      id: 4,
      report_name: t("generate_report.report_of_user_activity"),
      typeFile: "XLS",
    ...
    {
      id: 5,
      report_name: t("generate_report.report_of_notification"),
      typeFile: "XLS",
