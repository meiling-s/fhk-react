...
import { isEmptyOrWhitespace } from '../../../utils/utils'
...
const DetailFactory: FunctionComponent<Props> = ({
  ...
  useEffect(() => {
    ...
    const validate = async () => {
      ...
      if (isEmptyOrWhitespace(titleNameEng)) {
        tempV.push({
      ...
      if (isEmptyOrWhitespace(titleNameTchi)) {
        tempV.push({
      ...
      if (isEmptyOrWhitespace(titleNameSchi)) {
        tempV.push({
          ...
          >
            <CustomField label={t('common.traditionalChineseName')} mandatory>
              <CustomTextField
                ...
                error={
                  checkString(titleNameTchi) ||
                  isNameExisting(t('common.traditionalChineseName'))
                }
              />
            </CustomField>
            <CustomField label={t('common.simplifiedChineseName')} mandatory>
              <CustomTextField
                ...
                error={
                  checkString(titleNameSchi) ||
                  isNameExisting(t('common.simplifiedChineseName'))
                }
              />
            </CustomField>
            <CustomField label={t('common.englishName')} mandatory>
              <CustomTextField
                ...
                error={
                  checkString(titleNameEng) ||
                  isNameExisting(t('common.englishName'))
                }
              />
            </CustomField>
