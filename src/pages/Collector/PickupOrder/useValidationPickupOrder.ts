...
import { CreatePO, CreatePicoDetail, EditPo } from "../../../interfaces/pickupOrder";
...
const useValidationPickupOrder = (pico : CreatePO | EditPo, state : CreatePicoDetail[]) => {
    ...
    const errorMessages:any = {
        ...
        invalidDate: {
            messageEn: "Shipping validity start date should be lower than shipping validity end date",
