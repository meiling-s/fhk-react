...
function CreateCollectionPoint() {
    ...
    }, [colType, siteType, colName, address, openingPeriod, premiseName, premiseType, status, recyclables, staffNum, contractNo, skipValidation])
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="zh-cn">
                    <Grid container direction={"column"} spacing={2.5} sx={{...styles.gridForm}}>
                        ...
                        <CustomField label={t("col.address")} mandatory={true}>
                            ...
                            />
                            <Typography sx={styles.header3}>請輸入座數,街名,屋苑等資料</Typography> 
