      ...
      if (isRecyc) {
        ...
        if (matchingRecycType) {
          ...
          if (hasSubType && !selectedRecycSubType) {
            tempV.push({
              field: t("inventory.recycSubType"),
              problem: formErr.empty,
              type: "error",
            });
          }
        ...
        if (matchingProductType) {
          ...
          if (hasSubType && !productSubTypeId) {
            tempV.push({
              field: t("inventory.productSubType"),
              problem: formErr.empty,
              type: "error",
            });
          }
          ...
          if (productSubTypeId) {
            ...
            if (hasAddonType && !productAddon) {
              tempV.push({
                field: t("inventory.productAddonType"),
                problem: formErr.empty,
                type: "error",
              });
            }
