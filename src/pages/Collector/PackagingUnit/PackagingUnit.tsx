...
function createPackagingUnit(
  ...
  return { id, description, tenantId, packagingNameEng, packagingNameSchi, packagingNameTchi, remark, packagingTypeId, status, createdBy, updatedBy,createdAt, updatedAt }
}
