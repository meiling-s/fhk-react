import { Button, Modal, Typography, Pagination } from '@mui/material'
...
import { GET_ALL_STATUS } from '../../../constants/requests'
import { StatusGroup } from '../../../interfaces/statusGroup'
...
const PurchaseOrder = () => {
  ...
  const columns: GridColDef[] = [
    {
      field: 'createdAt',
      headerName: t('purchase_order_customer.table.created_datetime'),
      width: 150
    },
    {
      field: 'recycling_plant',
      headerName: t('purchase_order_customer.table.recycling_plant'),
      width: 150
    },
    {
      field: 'poId',
      headerName: t('purchase_order_customer.table.order_number'),
      width: 220,
      editable: true
    },
    {
      field: 'picoId',
      headerName: t('purchase_order_customer.table.pico_id'),
      type: 'string',
      width: 220,
      editable: true
    },
    {
      field: 'receiverAddr',
      headerName: t('purchase_order_customer.table.place_receipt'),
      type: 'string',
      width: 200,
      editable: true
    },
