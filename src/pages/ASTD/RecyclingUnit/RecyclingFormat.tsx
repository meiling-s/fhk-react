...
import { createRecyc } from '../../../APICalls/ASTD/recycling'
...
const RecyclingFormat: FunctionComponent<RecyclingFormatProps> = ({
    ...
    const handleSubmit = () => {
        ...
        const filteredRecyclingForm = recyclableType.filter(value => value.recycTypeId === chosenRecyclableType)

        console.log(filteredRecyclingForm, 'filteredRecyclingForm')

        const addRecyclingForm = {
            recyclableNameTchi: isMainCategory ? tChineseName : filteredRecyclingForm.length > 0 ? filteredRecyclingForm[0].recyclableNameTchi : '',
            recyclableNameSchi: isMainCategory ? sChineseName : filteredRecyclingForm.length > 0 ? filteredRecyclingForm[0].recyclableNameSchi : '',
            recyclableNameEng: isMainCategory ? englishName : filteredRecyclingForm.length > 0 ? filteredRecyclingForm[0].recyclableNameEng : '',
            description: isMainCategory ? description : filteredRecyclingForm.length > 0 ? filteredRecyclingForm[0].description : '',
            remark: isMainCategory ? remark : filteredRecyclingForm.length > 0 ? filteredRecyclingForm[0].remark : '',
            status: 'ACTIVE',
            createdBy: isMainCategory ? loginId : filteredRecyclingForm.length > 0 ? filteredRecyclingForm[0].createdBy : '',
            updatedBy: isMainCategory ? loginId : filteredRecyclingForm.length > 0 ? filteredRecyclingForm[0].updatedBy : '',
            recycSubType: isMainCategory ? [] : [
                {
