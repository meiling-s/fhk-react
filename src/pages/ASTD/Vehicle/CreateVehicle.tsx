...
const CreateEngineData: FunctionComponent<SiteTypeProps> = ({
  ...
  const [validation, setValidation] = useState<{ field: string; error: string; id:string }[]>([])
  ...
  useEffect(() => {
    const tempV: { field: string; error: string; id: string }[] = []
    ...
    tChineseName.trim() === '' &&
      tempV.push({
        ...
        id: `astd-vehicles-form-tc-err-warning-3317`
      })
    ...
    sChineseName.trim() === '' &&
      tempV.push({
        ...
        id: `astd-vehicles-form-sc-err-warning-8740`
      })
    ...
    englishName.trim() === '' &&
      tempV.push({
        ...
        id:`astd-vehicles-form-en-err-warning-8515`
      })
    ...
    Number(weight) < 0 &&
      tempV.push({
        ...
        id:`astd-vehicles-form-capacity-err-warning-1032`
      })
