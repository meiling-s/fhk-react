...
const EmailTemplate = ({templateId: string}) => {
            ...
            >
                ...
                <Grid display={'flex'} direction={'column'} rowGap={1}>
                    ...
                    <Autocomplete
                        ...
                        sx={{ width: 300 }}
                        renderInput={(params) => <TextField {...params} style={{backgroundColor: 'white'}} label={t('notification.modify_template.email.language')} />}
                        />
                </Grid>
                ...
                <Grid  display={'flex'} direction={'column'}>
                    ...
                    variant='contained'>
                        {t('notification.modify_template.email.button_submit')}
                    </Button>
                </Grid>
