...
import {
  CREATE_LOGISTIC_VEHICLE, DELETE_LOGISTIC_VEHICLE, DELETE_VEHICLE, EDIT_LOGISTIC_VEHICLE, EDIT_VEHICLE, GET_LOGISTIC_VEHICLE, SEARCH_LOGISTIC_VEHICLE
...
export const getAllVehicles = async (page: number, size: number) => {
  ...
  export const editVehicle = async (data: CreateLogisticVehicle, vehicleId: number) => {
    try {
      const token = returnApiToken()
